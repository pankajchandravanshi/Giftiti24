...
namespace Nop.Services.Catalog
{
    ...
    public partial class CategoryService : ICategoryService
    {
        ...
        /// <summary>
        /// Gets all categories displayed on the View all the category
        /// </summary>
        /// <param name="showHidden">A value indicating whether to show hidden records</param>
        /// <returns>
        /// A task that represents the asynchronous operation
        ...
        /// </returns>
        public virtual async Task<IList<Category>> GetAllCategoriesDisplayedOnCatgegoryAsync(bool showHidden = false)
        {
            var categories = await _categoryRepository.GetAllAsync(query =>
            {
                return from c in query.Take(3)
