...
namespace Nop.Web.Factories
{
    public partial class CatalogModelFactory : ICatalogModelFactory
    {
        ...
        #region Categories
        /// <summary>
        ///DD Prepare  category All models
        /// </summary>
        /// <returns>
        /// A task that represents the asynchronous operation
        /// The task result contains the list of homepage category models
        /// </returns>
        public virtual async Task<List<CategoryModel>> PrepareCategoryAllModelsAsync()
        {
            ...
            {
                var homepageCategories = await _categoryService.GetAllCategoriesDisplayedOnCatgegoryAsync();
